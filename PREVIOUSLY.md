...
- [x] changing description: 'Home of Furkies Purrkies and Westland Warrior', in /home/meow/Universe/Development/bowel/src/compiler/plugins/create-website/index.mjs
...
- [x] the v1 decompiler is allowed to be hacky as v1 directory structures are still a little bit messy, the v2 decompiler is not needed not that the server is baked in...
